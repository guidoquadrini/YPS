...
function renderCalendar() {
    ...
    calendar = $('#calendar').fullCalendar({
        ...
        eventDrop: function(event) {
            ...
            $.ajax({
                url: 'http://localhost/Q-AppWeb/Turnos/DropTurno.php',
        ...
        eventClick: function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost/Q-AppWeb/Turnos/BuscarEvento.php",
                data: "&id=" + event.id,
        ...
        eventSources:
                [
                    {
                        url: 'http://localhost/Q-AppWeb/Turnos/fullcalendar/php/get-events.php',
                        type: 'POST',
                        data: {
                            start: inical,
                            end: fincal,
